    ...
    public partial class finalmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    SluzbenikId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    Dimenzija = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Arhiva_AspNetUsers_SluzbenikId",
                        column: x => x.SluzbenikId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SluzbenikId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Predmeti", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Predmeti_AspNetUsers_SluzbenikId",
                        column: x => x.SluzbenikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
